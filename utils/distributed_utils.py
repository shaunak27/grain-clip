#Credits: LaCLIP Github Repo, Fan, Lijie et.al Improving CLIP Training with Language Rewrites
...
def init_distributed_mode(args):
    ...
    torch.distributed.init_process_group(backend=args.dist_backend,rank = args.rank, world_size=args.world_size)#, init_method=args.dist_url,
